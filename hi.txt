...
void setup() {
  ...
  display.begin(SSD1306_SWITCHCAPVCC, 0x3C); // Most common I2C address
  display.clearDisplay();
  display.setTextSize(1);
  display.setTextColor(WHITE);
  display.setCursor(0, 0);
  display.println("> Phisifi Booting...");
  display.display();
  delay(1500);
...
void updateDisplay() {
  ...
  display.println("> Phisifi Dashboard");
  display.println("--------------------");

  display.print("[*] Hotspot: ");
  display.println(hotspot_active ? "ACTIVE" : "OFF");

  display.print("[*] Deauth:  ");
  display.println(deauthing_active ? "ACTIVE" : "OFF");
  ...
  if (_selectedNetwork.ssid != "") {
    ...
    display.print("CH:   ");
    display.println(_selectedNetwork.ch);
  }

  if (_correct != "") {
    display.println("--------------------");
    display.setTextColor(BLACK, WHITE);  // Invert for effect
    display.print("PASS: ");
